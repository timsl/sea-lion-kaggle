...
def build_model():
    ...
    net1 = Inception3(24, 32, 16, c1, "net1")
    net2 = Inception3(24, 32, 16, net1, "net2")
    red1 = ConvFactory(32, 1, 0, net2, "red1")
    net3 = ConvFactory(32, 15, 0, red1, "net3")
    net4 = Inception3(112, 40, 20, net3, "net4")
    net5 = Inception3(48, 60, 30, net4, "net5")
    net6 = Inception3(48, 60, 30, net5, "net6")
    net7 = Inception3(64, 72, 32, net6, "net7")

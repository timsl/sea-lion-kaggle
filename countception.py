...
def build_model():
    ...
    net1 = Inception3(24, 40, 20, c1, "net1")
    net2 = Inception3(24, 40, 20, net1, "net2")
    red1 = ConvFactory(32, 1, 0, net2, "red1")
    net3 = ConvFactory(32, 15, 0, red1, "net3")
    net4 = Inception3(112, 40, 20, net3, "net4")
    net5 = Inception3(48, 80, 40, net4, "net5")
    net6 = Inception3(48, 80, 40, net5, "net6")
    net7 = Inception3(64, 96, 48, net6, "net7")
...
if PRINT_MSE:
    ...
    print("Test rounded-count MSE:", np.mean((np.round(pred_count * (pred_count > 0))-np_dataset_c_test)**2))
    print('!'*40)
